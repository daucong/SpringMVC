...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 02, 2022 lúc 05:39 PM
...
(1, 'dauthaicong11092001@gmail.com', '0869633830', 'Dau Thai Cong', '2 thanh son, Hai Chau, Da Nang', 0, 0, 'hello');
...
(2, 1, 'AliceBlue', '#F0F8FF', 'b.jpg'),
(3, 2, 'AntiqueWhite', '#FAEBD7', 'c.jpg'),
...
(8, 1, 'L,S,M', 'Name', 199999, 0, 'tital', 1, 1, 'details', '2020-04-09 11:38:43', '2020-04-09 11:38:43'),
...
(1, 'dauthaicong11092001@gmail.com', '$2a$12$4VjACfSCsnOu9Au9vGdgkuBt6VM8UOa3.GN3d6zWOP09C09PKW41a', 'daucong', '2 thanh son, Hai Chau, Da Nang');
...
ALTER TABLE `billdetail`
  ...
  ADD CONSTRAINT `billdetail_ibfk_3` FOREIGN KEY (`id_product`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
