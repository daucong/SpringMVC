					...
					<div class="well">
						...
						<form:form action="dang-ky" method="POST" modelAttribute="user">  
							<div class="control-group">
								...
								<label class="control-label" for="inputName">Họ và tên
									</label>
								<div class="controls">
									<form:input type="text" class="span3" path="display_name" placeholder="Mời nhập họ và tên" /> 
								</div>
								<label class="control-label" for="inputAddress">Địa chỉ
									</label>
								<div class="controls">
